 ...
 * of the "1" and "2". It then searches the grid rows and columns and
 * then diagonally from the left and right for how many times a player
 * shows up, if its equal to 3 then that player has won. It also gives points
 * of a 100 for winning, 200 if that is done in 7 or less but not less than
 * five moves, and finally gives 300 for winning in lessthan 5 moves.
 */
...
public class Problem4{
    public static void main(String[] args){
        ...
        //  Start Checking Diagonally From Left
        ...
        // System.out.println("Point counter " +playerCounter);
